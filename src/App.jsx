...
function App() {
  ...
  return (
    <>
      ...
      <section className="section-wrapper py-5 xl:py-7">
        <div className="w-full max-w-480 mx-auto px-4 sm:px-6 xl:px-12 2xl:px-20">
          ...
          <div className="reveal-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <Applications />
            <Birthdays />
            <Events />
          </div>
      ...
      <section className="section-wrapper section-alt py-5 xl:py-7">
        <div className="w-full max-w-480 mx-auto px-4 sm:px-6 xl:px-12 2xl:px-20">
          <div className="reveal mb-4">
